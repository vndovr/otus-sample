...
docker build . -t vndovr/otus-sample:event -t vndovr/otus-sample:order -t vndovr/otus-sample:auth -t vndovr/otus-sample:profile -t vndovr/otus-sample:account -t vndovr/otus-sample:bill -t vndovr/otus-sample:email --no-cache
